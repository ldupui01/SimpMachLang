...
public class SubInstructionTest {
	...
	public void setUp() throws Exception {
		sub = spy(new SubInstruction("L1",0,0,1));
		example = sub.toString();
	}

	@Test
	public final void testToString() {
		String expected = "L1: sub 0 - 1 to 0";
	...
	public final void testExecute() {
		...
		//test
		verify(m.getRegisters()).setRegister(0, -4);
	}

	@Test
	public final void testSubInstruction() {
		...
		assertTrue("SubInstruction is not an instance of instruction", sub instanceof Instruction);
